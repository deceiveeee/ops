...
import EvidenceJourney from "./EvidenceJourney";
import IFLessonLayout from "./IFLessonLayout";
import { Reveal, IF_7_1_SOURCE_BASIS } from "./shared";

export default function LessonIF_7_1() {
  return (
    <IFLessonLayout sourceBasis={IF_7_1_SOURCE_BASIS}>
      <section className="relative w-full overflow-hidden">
        ...
        <div className="relative pb-10 pt-4">
          <div className="ops-eyebrow flex items-center gap-3 text-xs">
            <span className="tabular-nums text-accent-amber">Mission 9</span>
            <span className="h-px w-8 bg-white/30" />
            <span>Investment Foundations · Test the claim</span>
          </div>
          ...
          <p className="ops-body mt-5 max-w-2xl text-lg leading-8 text-slate-200 sm:text-xl">
            Anyone can show you a strategy that beat the market. Learn the three tests that
            decide whether it really did, the ten faults that sink most of the evidence, and
            the return a claim has to clear once risk and your own trading costs are both
            charged against it.
          </p>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="ops-body-strong mt-2 max-w-xl text-[16px] text-white">
                    Read an event window, compute a portfolio study&apos;s extreme spread, set
                    up a regression correctly, pick the sampling design that survives the
                    survivor problem, then write the checklist you will hold every future
                    claim to.
                  </p>
                </div>
                <a
