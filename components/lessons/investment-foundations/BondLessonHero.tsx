...
export default function BondLessonHero({
  number,
  title,
  intro,
  mission,
  ...
  return (
    <section className="relative w-full overflow-hidden">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_30%_20%,rgba(251,191,36,0.11),transparent_55%)]" />
      <div className="pointer-events-none absolute right-[6%] top-8 h-32 w-32 rounded-full border border-accent-amber/10 shadow-[0_0_80px_rgba(251,191,36,0.08)]" />
      <div className="relative pb-10 pt-4">
        <div className="ops-eyebrow flex items-center gap-3 text-xs">
          ...
          <span>Investment Foundations · Mission 3</span>
        </div>
