import { PV_SOURCE_BASIS } from "./shared";

export default function PVSourceBasisPanel() {
  return (
    <aside aria-label="Source basis" className="glass-panel relative overflow-hidden p-5 sm:p-6">
