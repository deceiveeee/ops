...
import { RR_SOURCES } from "./shared";

export default function RRSourcePanel({ sources = RR_SOURCES }: { sources?: string[] }) {
  return (
    <aside
    ...
    >
      ...
      <p className="ops-muted mt-4 text-[12px]">
        Lesson content is adapted from MIT 15.401 Lecture 12 for educational use. No live market data.
      </p>
    </aside>
  );
}
