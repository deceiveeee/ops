    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-accent-cyan/25 bg-accent-cyan/[0.04] p-5">
          <div className="font-sans text-[11px] uppercase tracking-[0.16em] text-accent-cyan">Prior market expectations</div>
        ...
        <div className="rounded-2xl border border-accent-amber/25 bg-accent-amber/[0.04] p-5">
          <div className="font-sans text-[11px] uppercase tracking-[0.16em] text-accent-amber">Management&apos;s announced plan</div>
          <ul className="mt-3 space-y-2 text-[14px] text-slate-100">
      ...
      <div className="rounded-2xl border border-white/12 bg-white/[0.03] p-5 sm:p-6">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div className="rounded-xl border border-accent-green/20 bg-accent-green/[0.04] p-4">
            <div className="font-sans text-[10px] uppercase tracking-[0.14em] text-accent-green">Question 1: Does it create value?</div>
          ...
          <div className="rounded-xl border border-accent-red/20 bg-accent-red/[0.04] p-4">
            <div className="font-sans text-[10px] uppercase tracking-[0.14em] text-accent-red">Question 2: Better or worse than expected?</div>
