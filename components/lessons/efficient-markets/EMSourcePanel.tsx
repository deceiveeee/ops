...
import { EM_SOURCES } from "./shared";

export default function EMSourcePanel({ sources = EM_SOURCES }: { sources?: string[] }) {
  return (
    <aside
    ...
    >
      ...
      <p className="ops-muted mt-4 text-[12px]">
        Lesson content is adapted from MIT 15.401 Lecture 21 for educational use. All market scenarios
        and company examples are illustrative, not investment advice. The Challenger case is discussed
        as a historical event using publicly available facts.
      </p>
    </aside>
  );
}
