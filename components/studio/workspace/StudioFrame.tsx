...
export const SECTIONS = [
  ...
  { key: "goals", label: "Goals", href: "/studio/goals", covers: ["/studio/goals"] },
  {
    ...
    covers: ["/studio/research", "/studio/investigate", "/studio/industry", "/studio/filings", "/studio/competition"],
  },
...
const TOOL_PAGES = ["/studio/investigate", "/studio/industry", "/studio/filings", "/studio/competition"];
