  ...
  return (
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <nav aria-label="Footer"><Link href="/courses">Courses</Link><Link href="/studio">Studio</Link><Link href="/filings">Company reports</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></nav>
      </div>
